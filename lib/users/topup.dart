                ...
                ElevatedButton(
                  onPressed: () async {
                    ...
                    if (_formKey.currentState!.validate()) {
                      ...
                      // final transaction = await _midtrans.createTransaction(
                      //   amount: amount,
                      ...
                      // Post the transaction to RTDB
                      // final ref = _database.reference().child('transactions');
                      // ref.push().set({
                      //   'amount': amount,
                      ...
                      final ref = _database
                          .reference()
                          .child('Listrik')
                          .child(userMap.keys.first);
                      double totkwh = userMap[userMap.keys.first]['kwhToken'] +
